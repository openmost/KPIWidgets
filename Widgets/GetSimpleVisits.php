 ...
 *
 */
namespace Piwik\Plugins\SimpleVisits\Widgets;
 ...
 */
class GetSimpleVisits extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('SimpleVisits_SimpleVisits');
         ...
         */
        $config->setName('SimpleVisits_SimpleVisits');
    ...
    public function render()
    {
        ...
        $result = \Piwik\API\Request::processRequest('VisitsSummary.getVisits',array('format' => "PHP"));
        return '<div class="widgetBody"><p class="visites">'. $result .'</p></div>';
    }
